...
docker image rm -f logickee/openbox-puppeteer-chrome
...
cd dockerfiles/final
  ...
  docker build . \
    -t logickee/openbox-puppeteer-chrome

  # TODO: tag openbox-puppeteer-chrome here
cd -


# docker image tag logickee/openbox-poe-seat-apps logickee/openbox-puppeteer-chrome

docker push logickee/openbox-poe-seat-base
docker push logickee/openbox-poe-seat-apps
docker push logickee/openbox-puppeteer-chrome
