...
let send_slack_msg_command=`curl https://hooks.slack.com/services/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 -X POST -H 'Content-type: application/json' --data '{"text":"Hello, World!"}'`;
